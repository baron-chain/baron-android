...
public class MainTokensFragment extends BaseFragment {
    ...
    private void onNativeGrpcItem(TokensAdapter.AssetHolder holder, final int position) {
        ...
        if (coin.denom.equalsIgnoreCase(WDp.mainDenom(mBaseChain))) {
            ...
            holder.itemBalance.setText(WDp.getDpAmount2(getMainActivity(), totalAmount, mainDecimal, 6));
            holder.itemValue.setText(WDp.dpUserCurrencyValue(getBaseDao(), coin.denom, totalAmount, mainDecimal));

        } else {
            if (coin.denom.equalsIgnoreCase(TOKEN_ION)) {
            ...
            } else if (coin.denom.equalsIgnoreCase(TOKEN_USDX)) {
                Picasso.get().load(KAVA_COIN_IMG_URL + coin.denom + ".png") .fit().placeholder(R.drawable.token_ic).error(R.drawable.token_ic) .into(holder.itemImg);
            ...
            } else if (coin.denom.equalsIgnoreCase(TOKEN_SWP)) {
                Picasso.get().load(KAVA_COIN_IMG_URL + coin.denom + ".png") .fit().placeholder(R.drawable.token_ic).error(R.drawable.token_ic) .into(holder.itemImg);
        ...
        holder.itemRoot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mNativeGrpc.get(position).denom.equalsIgnoreCase(WDp.mainDenom(mBaseChain))) {
