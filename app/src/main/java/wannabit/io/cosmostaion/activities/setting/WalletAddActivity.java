...
public class WalletAddActivity extends BaseActivity implements View.OnClickListener, TaskListener {
    ...
    private class AccountListAdapter extends RecyclerView.Adapter<AccountListAdapter.AccountHolder> {
        ...
        public void onBindViewHolder(@NonNull AccountHolder holder, int position) {
            ...
            holder.accountCard.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (derive.selected) {
                        holder.accountCard.setBackground(ContextCompat.getDrawable(WalletAddActivity.this, R.drawable.box_round_seleted_white_daynight));
                    } else {
                        holder.accountCard.setBackground(ContextCompat.getDrawable(WalletAddActivity.this, R.drawable.box_account_unselected));
                    }
                    onUpdateCnt();
        ...
        private void loadBalance(AccountHolder holder, Derive derive) {
            if (derive.coin != null) {
                WDp.showCoinDp(WalletAddActivity.this, getBaseDao(), derive.coin, holder.accountDenom, holder.accountAvailable, derive.baseChain);
                return;
            }
