...
//                WLog.w("COSMOS_MAIN " + ApiClient.getCosmosApi(mApp).getAccountTxsCustom(mAddress, "50").request().url());
                ...
                Response<ArrayList<ResApiNewTxListCustom>> response = ApiClient.getProvenanceApi(mApp).getNewAccountTxCustom(mAddress, "50").execute();
                if (response.isSuccessful() && response.body() != null) {
                    mResult.resultData = response.body();
                    mResult.isSuccess = true;
                } else {
                ...
                Response<ArrayList<ResApiNewTxListCustom>> response = ApiClient.getCerberusApi(mApp).getNewAccountTxCustom(mAddress, "50").execute();
                if (response.isSuccessful() && response.body() != null) {
                    mResult.resultData = response.body();
                    mResult.isSuccess = true;
                } else {
                ...
                Response<ArrayList<ResApiNewTxListCustom>> response = ApiClient.getOmniflixApi(mApp).getNewAccountTxCustom(mAddress, "50").execute();
                if (response.isSuccessful() && response.body() != null) {
                    mResult.resultData = response.body();
                    mResult.isSuccess = true;
                } else {
            ...
            } else if (mChain.equals(BaseChain.CRESCENT_MAIN)) {
                Response<ArrayList<ResApiNewTxListCustom>> response = ApiClient.getCrescentApi(mApp).getNewAccountTxCustom(mAddress, "50").execute();
                if (response.isSuccessful() && response.body() != null) {
                    mResult.resultData = response.body();
                    mResult.isSuccess = true;
                } else {
            ...
            } else if (mChain.equals(BaseChain.ASSETMANTLE_MAIN)) {
                Response<ArrayList<ResApiNewTxListCustom>> response = ApiClient.getMantleApi(mApp).getNewAccountTxCustom(mAddress, "50").execute();
                if (response.isSuccessful() && response.body() != null) {
                    mResult.resultData = response.body();
                    mResult.isSuccess = true;
                } else {
